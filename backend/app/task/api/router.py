...
from backend.app.task.api.v1.dynamic_schedule import router as dynamic_schedule_router
...
v1.include_router(dynamic_schedule_router, prefix='/dynamic-schedules')

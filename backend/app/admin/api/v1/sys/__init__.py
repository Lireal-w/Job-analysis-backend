...
from backend.app.admin.api.v1.sys.query import router as query_router
from backend.app.admin.api.v1.sys.report import router as report_router
...
router.include_router(query_router, prefix='/query', tags=['系统查询引擎'])
router.include_router(report_router, prefix='/reports', tags=['系统报表管理'])

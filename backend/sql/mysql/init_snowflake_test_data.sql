...
insert into sys_role_menu (id, role_id, menu_id)
values
(3048601260000001005, 2048601263515500544, 3048601260000000051),
(3048601260000001006, 2048601263515500544, 3048601260000000052),
(3048601260000001007, 2048601263515500544, 3048601260000000056),
(3048601260000001008, 2048601263515500544, 3048601260000000060),
(3048601260000001009, 2048601263515500544, 3048601260000000064);
...
values
(3048601260000005001, 'MySQL数据源读取权限', 'datasource', 3048601260000000001, '示例MySQL', 'read', 2048601263515500544, '允许测试角色读取示例MySQL数据源', true, now(), null),
(3048601260000005002, '用户表管理权限', 'table', null, 'sys_user', 'admin', 2048601263515500544, '允许测试角色管理sys_user表', true, now(), null);
